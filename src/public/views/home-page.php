...
<body class="bg-dark overflow-hidden">
      ...
      <button class=" btn btn-trasparent text-light d-xl-none d-md-none" id="s6003" type="button"
        ...
        <div class="offcanvas offcanvas-end bg-dark" tabindex="-1" id="offcanvasRight"
          ...
          <div class="offcanvas-body">
            ...
            <br>
            <br>
            <a class="navbar-brand font-questrial fs-5 text-light align-middle g-3" href="" data-bs-dismiss="offcanvas"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
      <div class="modal-content">
            ...
            if ($_SESSION['table'] == "utenti"):
              ...
              <div class="container p-3">
                <button type="button"
                  ...
                  onclick="ChangePage('add-payment.html')">
                  AGGIUNGI METODO DI PAGAMENTO
                </button>
              </div>
              <?php
        ...
        <div class="modal-footer" id="SaveModificheSerial" style="display: none;">
          <button type="button"
            class="btn btn-warning font-questrial mx-auto fw-bold d-flex justify-content-center w-50 g-3"
            data-bs-dismiss="modal" id="salva-modifiche-btn">
            <span class="material-symbols-outlined">
              flag
            </span>
            SALVA MODIFICHE
  ...
  <div class="container-fluid">
    <d class="row flex-nowrap">
      <div class="col-auto col-xl-2 px-sm-2 px-0 d-none d-sm-none d-xl-block rounded position-relative"
        style="background-color: #3e44496d;" id="bar-main">
        ...
        <div class="d-flex flex-column align-items-center align-items-sm-start px-2 pt-2 text-white"
          style="height: auto !important;" id="bar-child">
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100" id="menu"
            style="width: 110% !important;">
            <li class="nav-item w-100 p-3 d-flex " id="li-mk-ID"
              onclick="HandleAndView('li-mk-ID','serialMARKET-PLACE')">
              <div style="border: 1px solid #ffc107; margin-left:-10px; margin-right: 10px; display:block;"
                id="li-mk-ID-bar"></div>
            ...
            if ($_SESSION['table'] == "utenti"):
              ...
              <li class="nav-item w-100 p-3 d-flex" id="li-ai-ID" onclick="HandleAndView('li-ai-ID','serialAiContainer')">
                <div style="border: 1px solid #ffc107; margin-left:-10px; margin-right: 10px; display:none;"
                  id="li-ai-ID-bar"></div>
              ...
              <li class="nav-item w-100 p-3 d-flex" id="li-pre-ID"
                onclick="HandleAndView('li-pre-ID','serialPreferitiContainer')">
                <div style="border: 1px solid #ffc107; margin-left:-10px; margin-right: 10px;  display:none;"
                  id="li-pre-ID-bar"></div>
            ...
            if ($_SESSION['table'] == "utenti_ads"):
              ?>
              <li class="nav-item w-100 p-3 d-flex" id="li-add-ID"
                onclick="HandleAndView('li-add-ID','serialAddProductContainer')">
                <div style="border: 1px solid #ffc107; margin-left:-10px; margin-right: 10px;  display:none;"
                  id="li-add-ID-bar"></div>
            ...
            <br>
            <li class="nav-item w-100 p-3 d-flex" id="li-aiuto-ID"
              onclick="HandleAndView('li-aiuto-ID','serialHelpContainer')">
              <div style="border: 1px solid #ffc107; margin-left:-10px; margin-right: 10px;height : 26px; display:none;"
                id="li-aiuto-ID-bar"></div>
          ...
          <div class="container-fluid">
            ...
            <form class="d-flex" role="search" style="width: auto; min-width: 40% !important;">
              <input class="form-control form-control-sm me-2 fw-bold fs-6 w-100 outline-none font-questrial"
                type="text" placeholder="Cerca prodotto" aria-label="Search" name="ricerca_user" id="cerca-prodotto-input">
                      ...
                      <div class="modal-body">
                        <div class="card-body text-dark">
                          ...
                          <div class="mb-3 container p-3 g-4 font-questrial">
                            ...
                            <select class="form-select form-select-lg border-dark" id="tipologia-pc"
                          ...
                          <div class="mb-3 container p-3 g-4 font-questrial">
                            ...
                            <input placeholder="Inserisci preferenze o requisiti" title="Inpit title"
                              id="altre-specifiche" type="text" class="input_field2 form-control font-questrial">
                          </div>
                        </div>
                      </div>
                      <div class="modal-footer w-100">
                        <button type="button" class="btn btn-warning font-questrial fw-bold d-flex mx-auto"
                          data-bs-dismiss="modal" aria-label="Close" onclick="GetDataFromAi()">
                    ...
                    <div class="container-fluid d-flex justify-content-center gap-5">
                      ...
                      <div class="modal fade" id="modale-prodotto-1-preferiti" data-bs-backdrop="static"
                        ...
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5 font-questrial fw-bold" id="staticBackdropLabel">Apple
                                MacBook
                            ...
                            <div class="modal-body">
                              ...
                              <div class="card-body">
                                ...
                                <h6 class="font-questrial fw-bold text-warning-secondary text-center fs-5">$1700.30
                                </h6>
        ...
        <div class="col bg-dark" id="serialAddProductContainer">
          ...
          <div class="container-fluid overflow-y-auto bg-dark rounded p-4 mt-4 " id="style-1">
            ...
            <div class="container-fluid vstack gap-4" style="max-width: 840px;">
              ...
              <div class="modal fade text-dark font-questrial" id="modalAggiungiProdotto" data-bs-backdrop="static"
                data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      ...
                      <div class="card-body text-dark">
                        <div class="mb-3 container p-3 g-1 font-questrial">
                          <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                            ...
                            Link immagini</label>
                          <input placeholder="Incolla qui il link della prima immagine" title="Inpit title" id="url-img-1"
                            type="url" class="input_field2 form-control font-questrial" onchange="ShowImageInDiv('1')">
                          <br>
                          <div class="container" id="container-image-1"></div>
                          <input placeholder="Incolla qui il link della seconda immagine" title="Inpit title"
                            id="url-img-2" type="url" class="input_field2 form-control font-questrial"
                            onchange="ShowImageInDiv('2')">
                          <div class="container" id="container-image-2"></div>
                          <br>
                          <input placeholder="Incolla qui il link della terza immagine" title="Inpit title" id="url-img-3"
                            type="url" class="input_field2 form-control font-questrial" onchange="ShowImageInDiv('3')">
                        ...
                        <div class="mb-3 container p-3 g-4 font-questrial">
                          <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                            ...
                            Nominativo</label>
                          <input placeholder="Nominativo prodotto" title="Inpit title" id="nominativo" type="text"
                        ...
                        <div class="mb-3 container p-3 g-4 font-questrial">
                          <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                            ...
                            Link Dettagli</label>
                          <input placeholder="Link dettagli prodotto" title="Inpit title" id="link-dettagli" type="url"
                            class="input_field2 form-control font-questrial">
                        </div>
                        <div class="mb-3 container p-3 g-1 font-questrial">
                          <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                        ...
                        <div class="mb-3 container p-3 g-4 font-questrial">
                          <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                            ...
                            Prezzo (€)</label>
                          <input placeholder="Inserisci prezzo" title="Inpit title" id="prezzo" type="number"
                            class="input_field2 form-control font-questrial">
                        </div>
                        <div class="mb-3 container p-3 g-4 font-questrial">
                          <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                    ...
                    <div class="modal-footer w-100">
                      <button type="button" class="btn btn-warning font-questrial fw-bold d-flex mx-auto"
                        data-bs-dismiss="modal" aria-label="Close" id="btn-add-product">
                        AGGIUNGI</button>
                    </div>
                  </div>
                </div>

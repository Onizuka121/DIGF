<?php require_once '../public/php/DbControl.php' ; $db_control=DBControl::getDB("root", "forge_db" ); ?>
  <!doctype html>
  <html lang="en">
            ...
            <form class="row g-4 container mx-auto rounded text-dark font-questrial">
              <div class="col-xl-7">
                ...
                <input title="Inpit title" name="nominativo-mod" type="text"
                  class="input_field2 form-control font-questrial" id="inputNominativo" value="Apple MacBook Air Test 1"
              ...
              <div class="col-xl-7">
                ...
                <select class="form-select form-select border-dark" name="categoria-pc-mod" id="selectCategoria"
                  onchange="ViewSalvaModifiche('2')">
...
Due porte Thunderbolt - USB 4
              ...
              <div class="col-xl-7">
                ...
                <input title="Inpit title" name="link-dett-mod" type="url"
                  ...
                  value="https://themewagon.github.io/electro/img/product01.png" onchange="ViewSalvaModifiche('2')">
              </div>
        ...
        <div class="col-auto col-xl-2 px-sm-2 px-0 d-none d-sm-none d-xl-block rounded"
          ...
          <div class="d-flex flex-column align-items-center align-items-sm-start px-2 pt-2 text-white"
            ...
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100"
              id="menu" style="width: 110% !important;">
                    ...
                    <div class="card-body">
                      ...
                      <div class="container-fluid d-flex justify-content-center gap-5">
                        ...
                        <div class="toast-container position-fixed bottom-0 end-0 p-3 font-questrial">
                          <div class="row">
                            <div class="col-auto">
                              <div class="toast toast-aggiunto p-1" role="alert" aria-live="assertive"
                                aria-atomic="true">
                              ...
                              <div class="modal-body">
                                ...
                                if ($_SESSION['table'] == "utenti_ads"):
                                  ...
                                  <p class="text-dark text-center font-questrial">
                                    ...
                                    <span class="badge text-bg-success align-middle">Marco Rossi</span>
                                  </p>
                                  <?php
                                endif
                                ?>
        ...
        if ($_SESSION['table'] == "utenti_ads"):
          ...
          <div class="col bg-dark" id="serialAddProductContainer">
            ...
            <div class="container-fluid overflow-y-auto bg-dark rounded p-4 mt-4 " id="style-1">
              ...
              <div class="container-fluid vstack gap-4" style="max-width: 840px;">
                <div class="d-flex container-fluid gap-4 flex-column" id="containerSerialAddedProducts">
                  <div class="card mb-3">
                    <span
                      class="position-absolute top-0 font-questrial fw-bold fs-6 start-50 translate-middle badge text-dark rounded-pill bg-warning">
                      AGGIUNTO 3 GIORNI FA
                              ...
                              <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h1 class="modal-title fs-5 font-questrial fw-bold" id="staticBackdropLabel">Apple
                                      MacBook
                                      Air <span class="badge text-bg-warning text-dark">NUOVO</span>
                                    </h1>
                        ...
                        <div class="card-body text-dark">
                          <div class="mb-3 container p-3 g-1 font-questrial">
                            <label for="" class="form-label font-questrial fs-5 fw-bold d-flex gap-1">
                              ...
                              Link immagini</label>
                            <input placeholder="Incolla qui il link della prima immagine" title="Inpit title"
                              id="url-img-1" type="url" class="input_field2 form-control font-questrial"
                            ...
                            <br>
                            <input placeholder="Incolla qui il link della terza immagine" title="Inpit title"
                              id="url-img-3" type="url" class="input_field2 form-control font-questrial"

    ...
    <nav class="navbar">
        <div class="container-fluid">
            ...
            <div class="d-grid gap-2 d-md-block d-none font-questrial">
                <button class="btn btn-warning fw-bold" type="button" onclick="ChangePage('login.php')">ACCEDI</button>
                <button class="btn fw-bold text-light" id="regSerialButton" type="button"
                    onclick="ChangePage('registrazione.php')">REGISTRATI</button>
            </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 col-xl-3">
                    <div class="widget">
                        ...
                        <address class="mb-4"><a class="link-secondary text-decoration-none"
                                href="https://maps.app.goo.gl/rLgtUrixqP7FiUJU7">Via Grottaferrata 23,Roma,Italia</a>
                        </address>
                        <p class="mb-1">
